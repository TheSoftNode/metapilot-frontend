...
//                     <g opacity="0.2">
//                         {/* Outer circle */}
//                         <circle cx="250" cy="400" r="200" fill="none" stroke="#3B82F6" strokeWidth="0.5" />

//                         {/* Inner circles */}
//                         <circle cx="250" cy="400" r="150" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                         <circle cx="250" cy="400" r="100" fill="none" stroke="#3B82F6" strokeWidth="0.5" />
//                         <circle cx="250" cy="400" r="50" fill="none" stroke="#4F46E5" strokeWidth="0.5" />

//                         {/* Intersecting lines through circles */}
//                         <line x1="50" y1="400" x2="450" y2="400" stroke="#3B82F6" strokeWidth="0.5" />
//                         <line x1="250" y1="200" x2="250" y2="600" stroke="#3B82F6" strokeWidth="0.5" />
//                         <line x1="100" y1="250" x2="400" y2="550" stroke="#3B82F6" strokeWidth="0.5" />
//                         <line x1="100" y1="550" x2="400" y2="250" stroke="#3B82F6" strokeWidth="0.5" />
//                     </g>

//                     {/* Right side decorative blockchain structure */}
//                     <g opacity="0.2" transform="translate(1150, 400)">
//                         <polygon points="0,0 60,-30 120,0 120,60 60,90 0,60" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                         <polygon points="0,0 -60,-30 -120,0 -120,60 -60,90 0,60" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                         <polygon points="0,0 0,-60 60,-90 120,-60 120,0 60,-30" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                         <polygon points="0,0 0,-60 -60,-90 -120,-60 -120,0 -60,-30" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                         <polygon points="0,60 0,120 60,150 120,120 120,60 60,90" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                         <polygon points="0,60 0,120 -60,150 -120,120 -120,60 -60,90" fill="none" stroke="#4F46E5" strokeWidth="0.5" />
//                     </g>
...
//                     {/* Abstract binary/data patterns scattered across */}
//                     <g opacity="0.15">
...
//                     {/* Animated pulse rings (visual only, animation in CSS) */}
//                     <circle cx="750" cy="400" r="25" fill="none" stroke="#6366F1" strokeWidth="0.5" className="pulse-ring" />
//                     <circle cx="750" cy="400" r="45" fill="none" stroke="#6366F1" strokeWidth="0.3" className="pulse-ring delay-1" />
//                     <circle cx="750" cy="400" r="65" fill="none" stroke="#6366F1" strokeWidth="0.2" className="pulse-ring delay-2" />
//                 </svg>
//             </div>
